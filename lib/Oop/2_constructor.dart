// Constructor so tar class ta khu ko instantiate load lite tar net a char method twe variable twe ko call sayar ma lo bal tan p a load load
//Constructor => default Constructor , Name Constructor , factory constructor

void main() {
  Student mama =
      Student(); // default constructor // khu lo Student so p pyan khaw tar ko Instantiate load tar lo khaw
...
class Student {
  ...
  // Factory Constructor =>
  // - return pyan - class htel mar factory constructor ta khu ray yin class name net pat that tet data type ta khu khu ko return pyan pay
